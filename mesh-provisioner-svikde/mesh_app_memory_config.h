...
#define MESH_CFG_MAX_MODELS                     0x15
...
#define MESH_CFG_MAX_PROVISIONED_DEVICES        5
#define MESH_CFG_MAX_PROVISIONED_DEVICE_APPKEYS 0
#define MESH_CFG_MAX_PROVISIONED_DEVICE_NETKEYS 5
#define MESH_CFG_MAX_FOUNDATION_CLIENT_CMDS     5
